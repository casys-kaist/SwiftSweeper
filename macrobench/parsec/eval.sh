...
case $BENCH_TARGET in
    ...
    "markus")
        ...
        ;;
    "minesweeper")
        export LD_PRELOAD="$HOME/minesweeper-analyze/lib/libminesweeper.so:$HOME/minesweeper-analyze/lib/libjemalloc.so"
        ;;
    "hushvac")
        export LD_PRELOAD="$HOME/hushvac/libhushvacnpmt.so"
        ;;
    "hushvac+")
        export LD_PRELOAD="$HOME/hushvac-analyze/libhushvacnpmt.so"
        ;;
    * )
        ;;
esac
