...
do
    ...
    do  
        ...
        SERVER_COMMAND="cd SwiftSweeper-User/macrobench/common; ./run_apache_nginx_client.sh apache2 ${num_connection} ${NUM_THREADS} ${BENCH_SEC} ${LIBC}"
